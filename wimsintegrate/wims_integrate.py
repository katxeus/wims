...
from wimsintegrate.core import Preferences
from wimsintegrate.core.cloud_api import CloudNetworkAccessManager
from wimsintegrate.gui.cloud_browser_tree import (
    QFieldCloudItemGuiProvider,
    QFieldCloudItemProvider,
)
from wimsintegrate.gui.cloud_login_dialog import CloudLoginDialog
from wimsintegrate.gui.cloud_projects_dialog import CloudProjectsDialog
from wimsintegrate.gui.cloud_transfer_dialog import CloudTransferDialog
from wimsintegrate.gui.map_layer_config_widget import MapLayerConfigWidgetFactory
from wimsintegrate.gui.package_dialog import PackageDialog
from wimsintegrate.gui.preferences_widget import PreferencesWidget
from wimsintegrate.gui.project_configuration_dialog import ProjectConfigurationDialog
from wimsintegrate.gui.project_configuration_widget import ProjectConfigurationWidget
from wimsintegrate.gui.synchronize_dialog import SynchronizeDialog


class QFieldSyncProjectPropertiesFactory(QgsOptionsWidgetFactory):
    """
    Factory class for WIMSIntegrate project properties widget
    """
    ...
    def icon(self):
        return QIcon(
            os.path.join(os.path.dirname(__file__), "resources", "wims_logo.svg")
        )
...
class WIMSIntegrate(object):
    """QGIS Plugin Implementation."""

    QFIELD_SCOPE = "WIMSIntegrate"
    ...
    def __init__(self, iface):
        ...
        self.translator.load(locale, "wimsintegrate", "_", locale_path)

        QCoreApplication.installTranslator(self.translator)

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr("&WIMSIntegrate")
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(self.tr("WIMSIntegrate Toolbar"))
        self.toolbar.setObjectName("WIMSIntegrate Toolbar")
        ...
        self.mapLayerConfigWidgetFactory = MapLayerConfigWidgetFactory(
            "WIMS",
            QIcon(os.path.join(os.path.dirname(__file__), "resources/wims_logo.svg")),
        )
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate("WIMSIntegrate", message)
    ...
    def initGui(self):
        ...
        self.cloud_projects_overview_action = self.add_action(
            ...
            text=self.tr("WIMS Server Projects Overview"),
        ...
        self.sync_action_toolbar = self.add_action(
            ...
            text=self.tr("Synchronize from WIMS"),
        ...
        if Qgis.QGIS_VERSION_INT >= 31500:
            ...
            self.project_properties_factory.setTitle("WIMS")
        ...
        self.options_factory.setTitle(self.tr("WIMS"))
    ...
    def show_project_configuration_dialog(self):
        ...
        """
        if Qgis.QGIS_VERSION_INT >= 31500:
            self.iface.showProjectPropertiesDialog("WIMS")
        else:
