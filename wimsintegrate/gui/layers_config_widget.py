...
from wimsintegrate.core.message_bus import message_bus
from wimsintegrate.gui.utils import set_available_actions
    ...
    def reloadProject(self):
        ...
        if self.unsupportedLayersList:
            ...
            unsupported_layers_text += self.tr(
                "There are unsupported layers in your project which will not be available in WIMS."
            )
            unsupported_layers_text += self.tr(
