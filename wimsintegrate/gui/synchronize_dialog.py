...
from wimsintegrate.utils.qgis_utils import import_checksums_of_project
from wimsintegrate.utils.qt_utils import make_folder_selector
...
class SynchronizeDialog(QDialog, DialogUi):
    ...
    def start_synchronization(self):
        ...
        try:
            ...
            self.iface.messageBar().pushWarning("WIMSIntegrate", str(e))
