...
try:
    ...
    QMessageBox.warning(
        None,
        QCoreApplication.translate("WIMSIntegrate", "Please restart QGIS"),
        QCoreApplication.translate(
            "WIMSIntegrate", "To finalize the WIMSIntegrate upgrade, please restart QGIS."
        ),
    )
...
from wimsintegrate.core.preferences import Preferences
from wimsintegrate.gui.checker_feedback_table import CheckerFeedbackTable
from wimsintegrate.gui.dirs_to_copy_widget import DirsToCopyWidget
...
class PackageDialog(QDialog, DialogUi):
    ...
    def show_warning(self, _, message):
        ...
        QgsApplication.instance().messageLog().logMessage(message, "WIMSIntegrate")
